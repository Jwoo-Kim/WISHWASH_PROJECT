		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "전표 역분개 및 수정 프로그램",
									"targetURL": "#sapbtpzbbfitaoj-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"sapbtpzbbfitaoj-display": {
								"semanticObject": "sapbtpzbbfitaoj",
								"action": "display",
								"description": "전표 역분개 및 수정 프로그램",
								"title": "전표 역분개 및 수정 프로그램",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sap.btp.zbbfitaoj",
									"url": sap.ui.require.toUrl("sap/btp/zbbfitaoj")
								}
							}
						}
					}
